...
app.get('/api', (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      {method: 'GET', path: '/api/exercise2/', description: 'Returns the information regarding the group information and the status of exercise 2.'},
...
app.get('/api/exercise2/',(req,res)=>{
  res.send("group 182 application deployed using docker")
});
